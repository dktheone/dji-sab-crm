...
;(function (bootstrap) {
    ...
    function Toast(props) {
        ...
        this.props = {
            ...
            position: "bottom-0 end-0", // top right
...
function ConfirmMSG(msg) {
    const toast = bootstrap.showToast({
        ...
        body: "<p>" + msg + "</p><div><button class='btn btn-primary me-1 btn-sm'>Click me</button><button class='btn btn-secondary btn-sm' data-bs-dismiss='toast'>Close</button></div>",
        delay: 20000
    })
    toast.element.querySelector(".btn-primary").addEventListener("click", () => {
        bootstrap.showToast({
            body: "Thank you for clicking", direction: "append", closeButtonClass: "btn-close-white"
        })
    })
}
